...
export const createPartSchema = z.object({
  ...
  category: z.enum(VALID_CATEGORIES as [PartCategory, ...PartCategory[]], { required_error: 'Category is required' }),
  unit: z.enum(VALID_UNITS as [PartUnit, ...PartUnit[]], { required_error: 'Unit is required' }),
...
export const receiveStockSchema = z.object({
  ...
  items: z.array(z.object({
    ...
    unit: z.enum(VALID_UNITS as [PartUnit, ...PartUnit[]]),
