  ...
  return (
    <div className="flex flex-col h-full">
      ...
      >
        ...
        />
        {!content && (
          <p className="text-slate-400 italic">{t('common.trainingShared.textLesson.noContent')}</p>
        )}
      ...
      <div className="bg-white border-t border-slate-200 px-4 py-3">
        {progress?.completed ? (
          <div className="flex items-center justify-center gap-2 text-green-600 font-medium py-2">
            <CheckCircle size={18} />
            {t('common.trainingShared.textLesson.markedRead')}
          </div>
        ) : (
          <button
            ...
            aria-label={t('common.trainingShared.textLesson.markAsReadAria')}
          >
            <CheckCircle size={18} />
            {canComplete ? t('common.trainingShared.textLesson.markAsRead') : t('common.trainingShared.textLesson.scrollToComplete')}
          </button>
        )}
      </div>
    </div>
