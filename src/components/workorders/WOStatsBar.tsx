...
export function WOStatsBar() {
  ...
  const statItems = [
    {
      label: t('common.workOrders.copy.openWOs'),
      value: stats?.openCount ?? '',
      color: 'text-blue-600',
    },
    {
      label: t('common.workOrders.copy.overdueWOs'),
      value: stats?.overdueCount ?? '',
      color: 'text-red-600',
    },
    {
      label: t('common.workOrders.copy.avgCompletionTime'),
      value: stats ? formatDuration(stats.avgCompletionTimeMinutes) : '',
      color: 'text-gray-700',
    },
    {
      label: t('common.workOrders.copy.completedThisWeek'),
