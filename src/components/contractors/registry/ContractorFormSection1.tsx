  ...
  return (
    <section className="space-y-4" id="contractor-form-company">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <input name="registrationNumber" placeholder="Registration Number *" className="h-10 rounded-md border border-slate-200 px-3 text-sm" />
        ...
        <input name="city" placeholder="City *" className="h-10 rounded-md border border-slate-200 px-3 text-sm" />
        <input name="district" placeholder="District" className="h-10 rounded-md border border-slate-200 px-3 text-sm" />
        <input name="country" placeholder="Country *" className="h-10 rounded-md border border-slate-200 px-3 text-sm" />
        <input name="website" placeholder="Website" className="h-10 rounded-md border border-slate-200 px-3 text-sm sm:col-span-2" />
        <textarea name="primaryAddress" placeholder="Primary Address *" className="min-h-24 rounded-md border border-slate-200 px-3 py-2 text-sm sm:col-span-2" />
