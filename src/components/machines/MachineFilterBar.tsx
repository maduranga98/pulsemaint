...
const statusOptions: { value: MachineStatus; labelKey: string }[] = [
  { value: 'active', labelKey: 'common.machines.filters.statusOptions.active' },
  { value: 'under_maintenance', labelKey: 'common.machines.filters.statusOptions.under_maintenance' },
  { value: 'decommissioned', labelKey: 'common.machines.filters.statusOptions.decommissioned' },
];

const criticalityOptions: { value: MachineCriticality; labelKey: string }[] = [
  { value: 5, labelKey: 'common.machines.filters.criticalityOptions.5' },
  { value: 4, labelKey: 'common.machines.filters.criticalityOptions.4' },
  { value: 3, labelKey: 'common.machines.filters.criticalityOptions.3' },
  { value: 2, labelKey: 'common.machines.filters.criticalityOptions.2' },
  { value: 1, labelKey: 'common.machines.filters.criticalityOptions.1' },
];

const healthScoreOptions = [
  { min: 70, max: 100, labelKey: 'common.machines.filters.healthOptions.good', key: 'good' as const },
  { min: 40, max: 69, labelKey: 'common.machines.filters.healthOptions.warning', key: 'warning' as const },
  { min: 0, max: 39, labelKey: 'common.machines.filters.healthOptions.critical', key: 'critical' as const },
];
    ...
    <div className="bg-white rounded-lg border border-gray-200 p-4 space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="flex-1">
          <input
            type="text"
            placeholder={t('common.machines.filters.searchPlaceholder')}
            value={search}
      ...
      <div className="space-y-2">
        <label className="text-sm font-medium text-gray-700">{t('common.machines.filters.status')}</label>
      ...
      {/* Criticality */}
      <div className="space-y-2">
        <label className="text-sm font-medium text-gray-700">{t('common.machines.filters.criticality')}</label>
        <div className="flex flex-wrap gap-2">
      ...
      {departments.length > 0 && (
        <div className="space-y-2">
          <label className="text-sm font-medium text-gray-700">{t('common.machines.filters.department')}</label>
          <div className="flex flex-wrap gap-2">
      ...
      {/* Health Score */}
      <div className="space-y-2">
        <label className="text-sm font-medium text-gray-700">{t('common.machines.filters.healthScore')}</label>
        <div className="flex flex-wrap gap-2">
