...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // as does trainee's, safety_officer's, and hr_officer's own
      // "My Training" / "My Program" (see that group).
      { labelKey: 'common.nav.items.myTraining', to: '/app/training/my-modules', icon: Icon.book, roles: ['floor_operator', 'plant_manager'] },
