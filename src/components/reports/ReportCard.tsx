...
import { getReportName } from '../../utils/reports/reportDefinitions';
  ...
  return (
    <article className="rounded-xl border border-[#1E3A5F] bg-[#0F1E35] p-5 transition duration-200 hover:-translate-y-0.5 hover:border-[#2E5A8F]">
      <div className="flex items-center gap-3">
        ...
        <h3 className="min-w-0 flex-1 truncate text-base font-semibold text-[#F0F4F8]">{getReportName(report, t)}</h3>
      </div>
      ...
      <div className="mt-4 flex justify-end">
        ...
        >
          ...
          {t('common.reports.card.actions.generate')}
        </button>
      </div>
    </article>
  );
