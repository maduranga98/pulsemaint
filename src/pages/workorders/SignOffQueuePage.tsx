...
/**
 * Completed work orders awaiting sign-off. A supervisor sees only the work
 * orders they are the supervisor-in-charge of; plant managers and admins (who
 * oversee the whole plant) see all completed work orders. Training sign-off
 * lives in the Training module, not here.
 */
