...
import TriageRunnerScreen from '../../components/triage/runner/TriageRunnerScreen';

export default function TriageRunnerPage() {
  ...
  return <TriageRunnerScreen session={session} />;
}
