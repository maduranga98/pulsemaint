...
export const REPORT_COLUMNS: Partial<Record<ReportType, ReportColumn[]>> = {
  ...
  technician_performance: [
    { key: 'role', label: 'Role' },
    { key: 'memberCount', label: 'Members', format: 'number' },
    { key: 'avgEvaluationScore', label: 'Avg Evaluation Score', format: 'number' },
    { key: 'evaluationCount', label: 'Evaluations', format: 'number' },
    { key: 'auditCount', label: 'Audits', format: 'number' },
    { key: 'trainingsCompleted', label: 'Trainings Completed', format: 'number' },
    { key: 'quizzesPassed', label: 'Quizzes Passed', format: 'number' },
    { key: 'avgQuizMark', label: 'Avg Quick Assessment Mark', format: 'number' },
  ],
